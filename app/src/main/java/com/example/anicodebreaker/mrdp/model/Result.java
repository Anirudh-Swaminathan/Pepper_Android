...
public class Result {
     ...
     * @param metadata
     */
    public Result(String source, String resolvedQuery, String action, boolean actionIncomplete, Parameters parameters, List<Object> contexts, Metadata metadata, Fulfillment fulfillment, double score) {
        super();
        this.source = source;
